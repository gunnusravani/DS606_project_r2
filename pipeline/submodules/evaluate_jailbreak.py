...
def evaluate_jailbreak(
    ...
    if "wildguard" in methodologies:
        ...
        #TODO: finsh the implementation of wildguard evaluation and collect the results
        
        evaluation['wildguard_harmful'] = np.mean([completion['wildguard']['response_harmful'] for completion in completions])
