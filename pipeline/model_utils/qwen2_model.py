...
REFUSAL_TOKENS_LANG = {
    ...
    'ru': [85391, 30174],
    'ko': [132759],
   'hi': [40, 19152, 39814, 44179, 60096, 64704, 78368, 79238, 87244, 91811, 93948, 145256, 145420, 145535, 145769, 145799, 145966, 146187, 146378, 146399, 146575, 146934, 148971],
   'bn': [40, 1249, 19152, 39814, 72258, 86548, 146026, 146415, 146711, 146775, 146838, 147271, 148014, 148125, 148204, 148222, 148291, 148431, 148868, 149525]  # Bengali characters
}
...
class Qwen2Model(ModelBase):
    ...
    def _get_refusal_toks(self, lang):
        return REFUSAL_TOKENS_LANG[lang]
